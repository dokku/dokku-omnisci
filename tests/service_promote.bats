...
@test "($PLUGIN_COMMAND_PREFIX:promote) changes DATABASE_URL" {
  ...
  dokku config:set my_app "DATABASE_URL=omnisci://u:p@host:3306/db" "DOKKU_OMNISCI_BLUE_URL=omnisci://omnisci:$password@dokku-omnisci-l:3306/l"
  dokku "$PLUGIN_COMMAND_PREFIX:promote" l my_app
  url=$(dokku config:get my_app DATABASE_URL)
  assert_equal "$url" "omnisci://omnisci:$password@dokku-omnisci-l:3306/l"
}
...
@test "($PLUGIN_COMMAND_PREFIX:promote) uses OMNISCI_DATABASE_SCHEME variable" {
  password="$(sudo cat "$PLUGIN_DATA_ROOT/l/PASSWORD")"
  dokku config:set my_app "OMNISCI_DATABASE_SCHEME=omnisci2" "DATABASE_URL=omnisci://u:p@host:3306/db" "DOKKU_OMNISCI_BLUE_URL=omnisci2://omnisci:$password@dokku-omnisci-l:3306/l"
  dokku "$PLUGIN_COMMAND_PREFIX:promote" l my_app
  url=$(dokku config:get my_app DATABASE_URL)
  assert_contains "$url" "omnisci2://omnisci:$password@dokku-omnisci-l:3306/l"
}
